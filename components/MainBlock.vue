<template>
  <div
    class="_container bg-[url('/images/main-andrey-mob.png')] sm:bg-[url('/images/main-andrey-tab.png')] xl:bg-[url('/images/main-andrey-desk.png')] pt-6 sm:pt-[38px] 2xl:pt-[100px] pb-6 sm:pb-5 xl:pb-6 2xl:pb-10 bg-no-repeat">
    <div class="max-w-[1080px]">
      <h1 class="fl-text-[1.625rem,5.125rem] leading-[120%] font-bold text-white uppercase">Более 15 лет успешной практики
    ...
    <div
      ...
      <div v-for="(item, i) in numbers" :key="i"
