<template>
  ...
  >
    <span class="text-sm font-bold text-white 2xl:text-base"> Мы используем файлы Cookie </span>

    <span class="text-sm text-white 2xl:text-base">
      Наш сайт использует файлы cookie, чтобы сделать его более удобным для Вас. Продолжая
      использовать сайт, вы соглашаетесь с
      <NuxtLink
        :to="contacts.policy?.url"
        target="_blank"
