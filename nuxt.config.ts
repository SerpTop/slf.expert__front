...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    modulbankSecretKey: process.env.MODULBANK_SECRET_KEY,
    modulbankTestKey: process.env.MODULBANK_TEST_KEY,
    modulbankShopId: process.env.MODULBANK_SHOP_ID,
    modulbankSbpUrl: process.env.MODULBANK_SBP_URL,
