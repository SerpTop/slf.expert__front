<template>
  <div ref="payFile" class="p-8 text-black bg-white shadow-md a4">
    ...
    <span class="block w-full mb-10 text-2xl font-bold text-center text-black">
    ...
    <section>
      <div class="overflow-x-auto">
          ...
          <tbody>
            <tr class="border-t">
              <td class="p-2 text-sm">
                Получатель <br />ИНН 525714971677 ИП Семин А.С.
              </td>
            ...
            <tr class="border-t">
              <td class="p-2 text-sm">
                Банк получателя <br />Московский филиал АО КБ «Модульбанк» ИП
                Семин А.С.
              </td>
              <td class="p-2 text-sm text-left">БИК <br />Сч №</td>
              <td class="p-2 text-sm text-left">
                044525092 <br />30101810645250000092
              </td>
            </tr>
          </tbody>
        </table>
        <span class="block w-full mt-6 text-2xl font-bold text-black">
        ...
        <span
          class="block w-full mt-6 text-2xl font-bold text-center text-black"
        >
        ...
        <table class="w-full mt-4 border-collapse">
          <tbody>
            ...
            <tr class="border-t">
              ...
              <td class="p-2 text-sm text-left">
                {{
                  ...
                  "Консультация управляющего партнера"
                }}
              </td>
              <td class="p-2 text-sm text-left">
            ...
            <tr class="border-t">
              ...
              <td class="p-2 text-sm text-end font-bold !border-0">
