<template>
  <div class="fixed top-0 left-0 w-full h-full z-[999] md:p-10 overflow-auto flex">
    <div
      class="absolute inset-0 z-20 w-full h-full cursor-pointer bg-white/20 backdrop-blur-2xl"
      ...
      <div v-show="!isSubmitSuccess && !isSubmitError">
        ...
        >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        v-if="selected"
                        class="absolute inset-y-0 left-0 flex items-center pl-1 text-white"
                      >
                        ✓
                      </span>
                    </li>
          ...
          <div class="flex justify-center w-full xl:col-span-2">
            ...
            >
              Оплатить
              <span>{{ serviceData?.price ? formatPrice(serviceData.price) : '0' }} ₽</span>
            </button>
          </div>
        </form>
      </div>
      ...
      >
        ...
        <div class="flex flex-col items-center gap-[6px]">
          ...
          <span class="text-sm text-gray-300"
            >Пожалуйста, отсканируйте QR-код в приложении вашего банка</span
          >
        </div>
        <IconCode />
...
<script setup>
  ...
  // Автоматически выбрать первого специалиста, если список не пустой
  watch(
    experts,
    (newExperts) => {
      if (newExperts && newExperts.length > 0 && !selectedExpert.value) {
        selectedExpert.value = newExperts[0];
      }
    },
    { immediate: true },
  );
